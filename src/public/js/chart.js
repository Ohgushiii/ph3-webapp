...
/* record chart */ 
{
  ...
  // var labels = jsonfile.jsonStudyData.map(function (e) {
  //   return e.study_date;
  // });
  // var data = jsonfile.jsonStudyData.map(function (e) {
  //   return e.study_time;
  // });

  
  var parsedData = JSON.parse(jsonStudyData);
  var labels = parsedData.map(function (e) {
      return e.study_date;
    });
  var data = parsedData.map(function (e) {
      return e.study_time;
    });
